 ...
 * blueprint/restore
 *
 * Re-publishes an old Blueprint version as a brand-new active version.
 * Owner-only, enforced by the Kernel - the Gateway just forwards the
 * credential and the version number being restored.
 */
...
export async function POST(req: NextRequest) {
  return forward(req, "blueprint.restore");
}
