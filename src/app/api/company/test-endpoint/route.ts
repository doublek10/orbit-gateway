 ...
 *
 * Test Console - signs and verifies a sample payload with the company's
 * real webhook secret, optionally previewing a saved Data Mapping.
 */
...
export async function POST(req: NextRequest) {
  return forward(req, "company.test_endpoint");
}
