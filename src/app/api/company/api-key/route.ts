 ...
 * company/api-key
 *
 * The Orbit API Generator - "the Company Owner requests an Orbit
 * endpoint". Generates the Company Endpoint identity (slug + webhook
 * signing secret) alongside a bearer API key.
 */
...
export async function POST(req: NextRequest) {
  return forward(req, "company.api_generate");
}
