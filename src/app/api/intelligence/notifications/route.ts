 ...
 *
 * Intelligence notifications. GET filters: unread_only, limit. POST { id } marks one read.
...
export async function GET(req: NextRequest) {
  return forward(req, "intelligence_notifications.list");
}

export async function POST(req: NextRequest) {
  return forward(req, "intelligence_notifications.create");
}
