 ...
 * integrations/test
 *
 * "Test Connection" for a Business System. Body is either { id } to
 * re-test an already-saved connection, or { provider, credentials } to
 * test before saving.
 */
...
export async function POST(req: NextRequest) {
  return forward(req, "integrations.test");
}
