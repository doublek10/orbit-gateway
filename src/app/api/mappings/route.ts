 ...
 * mappings
 *
 * The Blueprint's Visual JSON Mapper - saved source-field -> canonical-
 * field mappings that the Transformation Engine applies to a company's
 * own JSON shape.
 */
...
export async function GET(req: NextRequest) {
  return forward(req, "mappings.list");
}

export async function POST(req: NextRequest) {
  return forward(req, "mappings.create");
}
