 ...
 * whatsapp/disconnect
 *
 * Body is { id } for the whatsapp_links row to remove. Unlinking here
 * only removes the binding - it does not, and cannot, block the phone
 * number from messaging the Orbit WhatsApp number again; a fresh
 * pairing code would be required to re-link.
 */
...
export async function POST(req: NextRequest) {
  return forward(req, "whatsapp.delete");
}
